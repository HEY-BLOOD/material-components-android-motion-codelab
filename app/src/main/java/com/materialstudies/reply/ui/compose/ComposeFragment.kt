...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.run {
            ...
            // COMPLETED: Set up MaterialContainerTransform enterTransition and Slide returnTransition.
    ...
    private fun expandChip(chip: View) {
        ...
        // COMPLETED: Set up MaterialContainerTransform beginDelayedTransition.
