...
class HomeFragment : Fragment(), EmailAdapter.EmailAdapterListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // COMPLETED: Set up MaterialFadeThrough enterTransition.
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // COMPLETED: Set up postponed enter transition.
    ...
    override fun onEmailClicked(cardView: View, email: Email) {
        // COMPLETED: Set up MaterialElevationScale transition as exit and reenter transitions.
        ...
        // Set the mapping from start view (email list item) and end view (email details screen)
